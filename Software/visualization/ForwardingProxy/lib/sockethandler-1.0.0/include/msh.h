...
namespace SH
{
    ...
    public:
        ...
        void**  persistent(cppsock::socket& socket)    noexcept        {return &this->socket2data[&socket]->persistent;}
    ...
    public:
        ...
        void**  persistent(void)                noexcept        {return &this->sock_data.persistent;}
        bool    is_running(void)                const noexcept  {return this->running;}
    };
