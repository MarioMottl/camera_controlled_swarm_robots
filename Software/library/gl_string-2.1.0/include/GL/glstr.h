...
namespace gl
{
    ...
    ******************************************************************************************************************************************/
    ...
    public:
        ...
        inline static size_t vertex_offset(void) noexcept                {return 0;}
        inline static size_t color_offset(void) noexcept                 {return __vertex_component_count * sizeof(float);}
        inline static size_t tex_offset(void) noexcept                   {return (__vertex_component_count + __color_component_count) * sizeof(float);}
