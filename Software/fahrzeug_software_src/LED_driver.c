...
/**
 * @brief function to continusly switch a LED on/off from the software, used as an indicator for the RTOS Kernel status (crashed or not)
 * 
 * @param arg 
 */
...
void LED_init(void)
{
    ...
    GPIO_Init(GPIOC, &gpio);
    //set PC3 as output for Heartbeat LED
